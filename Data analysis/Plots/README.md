...
-   `boxPlotAgonistic.py`: Produces box plots to visualize agonistic behaviors (fleeing, circling, replacement) for control and pheromone groups, providing a comparison of these behaviors.
