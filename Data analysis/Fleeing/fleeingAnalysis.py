...
def main():
    ...
    parser.add_argument("fleeingFolder", type=str)
    args = parser.parse_args()

    savePath = args.fleeingFolder + "/" + "analysis"
    if not os.path.exists(savePath):
        os.makedirs(savePath) 

    # Fleeing Files
    incrementalFileOrder = ['0_2.csv', '0_7.csv', '0_9.csv', '0_17.csv']
    incrementalFiles = [args.fleeingFolder + "/" + i for i in incrementalFileOrder]
    otherFiles = [args.fleeingFolder + "/" + i for i in ["2_7.csv", "7_9.csv", "9_17.csv"]]
    completeFile = args.fleeingFolder + "/" + "0_17.csv"
